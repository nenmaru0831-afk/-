window.Settings = (() => {
  ...
  function bgmVolume() {
    return { x: 0, l: 0.48, m: 0.82, h: 1 }[data.bgmVol] ?? 0.82;
  }
  ...
  function tone(freq, dur, type, gain, delay) {
    ...
    try {
      ...
      g.gain.exponentialRampToValueAtTime((gain || 0.05) * 1.7, t + 0.012);
  ...
  return {
    ...
    beep, hover, shot, talk, skillCue, announce, fx, panelHtml, bindPanel
  };
})();
