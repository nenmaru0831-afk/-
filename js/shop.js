window.Bag = (() => {
  const ITEMS = [
    ...
    { id: "focus", name: "針の糸", price: 55, desc: "当たりを小さく", fx: "tiny", mark: "針" },
    { id: "rage", name: "赤唐辛子", price: 75, desc: "攻撃を少し強く", fx: "rage", mark: "辛" },
    { id: "luck", name: "四つ葉の偽札", price: 65, desc: "得点が増える", fx: "luck", mark: "葉" },
    ...
    { id: "ofuda", name: "使い回しの札", price: 50, desc: "弱い弾を撃つ", fx: "shot", mark: "札" },
    { id: "candy", name: "誰かの駄菓子", price: 20, desc: "ごく少し回復", fx: "heal8", mark: "菓" },
    { id: "stone", name: "道端の石", price: 10, desc: "ほとんど意味がない", fx: "stone", mark: "石" },
    { id: "mirror", name: "割れた鏡", price: 125, desc: "被弾を少し返す", fx: "reflect", mark: "鏡" },
    { id: "tea", name: "冷めた番茶", price: 35, desc: "足取りを直す", fx: "tea", mark: "茶" },
    { id: "clock", name: "止まった懐中時計", price: 160, desc: "敵の術を遅らせる", fx: "artslow", mark: "時計" },
    { id: "ribbon", name: "黒いリボン", price: 45, desc: "見た目だけ", fx: "none", mark: "紐" },
    { id: "map", name: "誤った地図", price: 30, desc: "迷う", fx: "invert", mark: "図" },
    { id: "bell", name: "猫の鈴", price: 70, desc: "雑魚を少し怯ませる", fx: "stun", mark: "猫" },
    { id: "oil", name: "灯油の余り", price: 55, desc: "弾に火がつく（得点）", fx: "luck", mark: "油" },
    { id: "seed", name: "南瓜の種", price: 25, desc: "回復はごくわずか", fx: "heal6", mark: "種" },
    { id: "contract", name: "怪しい契約書", price: 200, desc: "体力を削って大弾幕払い", fx: "pact", mark: "契" }
  ];
  ...
  function paint() {
    ...
    grid.innerHTML = ITEMS.map((it) => {
      ...
      return '<button type="button" class="shop-item' + (can ? "" : " is-off") + '" data-id="' + it.id + '">'
        + '<i>' + it.mark + '</i><b>' + it.name + '</b><small>' + it.desc + '</small><em>' + it.price + '</em>'
